...
import {Avatar,Box,Button,Divider,List,ListItem,ListItemAvatar,ListItemText,TextField,Typography,} from '@material-ui/core';
...
const Product = () => {
  ...
  const [comments, setComments] = useState([
    { text: 'This product is great!', date: '2023-03-05T08:16:12.126Z' },
    { text: 'I am really happy with this purchase.', date: '2023-03-04T14:32:45.872Z' },
  ]);
...
<TableRow>
<TableCell><strong>Product Style:</strong></TableCell>
<TableCell>{data?.Style}</TableCell>
</TableRow>
<TableRow>
<TableCell><strong>Product Shape:</strong></TableCell>
<TableCell>{data?.shape}</TableCell>
</TableRow>
<TableRow>
<TableCell><strong>Product Color:</strong></TableCell>
...
<TableRow>
<TableCell><strong>Shop Location:</strong></TableCell>
          ...
          <React.Fragment key={index}>
            <ListItem alignItems="flex-start" className={classes.comment}>
              ...
              <ListItemText
                ...
                secondary={
                  <Typography component="span" variant="body2" className={classes.commentDate}>
                    {moment(comment.date).format('MMM Do YYYY, h:mm:ss a')}
                  </Typography>
                }
              />
            </ListItem>
