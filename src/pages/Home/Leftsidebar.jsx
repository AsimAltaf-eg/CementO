...
<List>
  <Link to={`/ImageSearch`} className={classes.link}>
    <ListItem button key="ImageSearch" className={classes.listItemHover}>
      <ListItemIcon>
        <ImageSearchIcon />
      </ListItemIcon>
  ...
  <Link to={`/RoomVisualizer`} className={classes.link}>
    <ListItem button key="Room Visualizer" className={classes.listItemHover}>
      <ListItemIcon>
        <CalculateIcon />
      </ListItemIcon>
  ...
  <Link to={`/CostEstimator/TileCalculate`} className={classes.link}>
    <ListItem button key="tiles Cost Estimator" className={classes.listItemHover}>
      <ListItemIcon>
        <CalculateIcon />
      </ListItemIcon>
  ...
  <Link to={`/CostEstimator/BricksCalculate`} className={classes.link}>
    <ListItem button key="bricks Cost Estimator" className={classes.listItemHover}>
      <ListItemIcon>
        <CalculateIcon />
      </ListItemIcon>
