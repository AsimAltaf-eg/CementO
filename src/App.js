...
import CostEstimator from "./pages/CostEstimator/Cost";
import ShopsList from "./pages/ListShopvendor/Shop";
import SearchProductByShop from "./pages/ListShopvendor/ShopVendorProduct"
import BrickCalculator from "./pages/CostEstimator/BricksCalculate";
import TileCalculator from "./pages/CostEstimator/TileCalculate";
import RoomVisualizer from "./pages/RoomDesign/RoomDesigner";
import LocationMap from "./pages/LocationMap/Map";
// import PageLayout from "./pages/Home/Leftsidebar";
import "./app.scss";
import ChooseRoom from "./pages/RoomDesign/ChooseRoom";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/CostEstimator/BricksCalculate",
        element: <BrickCalculator />,
      },
      {
        path: "/CostEstimator/TileCalculate",
